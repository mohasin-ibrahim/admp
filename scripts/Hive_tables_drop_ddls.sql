...
drop table if exists staging.cov_deaths_nation;
drop table if exists staging.cov_deaths_yorkshire;
...
drop table if exists staging.fludeaths;
...
drop table if exists mart.fact_cov_deaths_and_vaccines;
